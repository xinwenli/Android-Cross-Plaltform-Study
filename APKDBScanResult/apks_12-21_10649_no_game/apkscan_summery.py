...
def apk_catigory_init(cat_dict, catigory_name):
    ...
    cat_dict["Androidx usage number"] = 0
    cat_dict["Androidx usage rate"] = 0
    return cat_dict
...
def apk_sum_update(sum_dict, new_cat_data):
    ...
    if sum_dict["App number"] != 0:
        sum_dict["Native library usage rate rate"] = (
            sum_dict["Native library usage number"] / sum_dict["App number"]
        )
        sum_dict["Platform usage number"] += new_cat_data["Platform usage number"]
        sum_dict["Platform usage rate rate"] = (
            sum_dict["Platform usage number"] / sum_dict["App number"]
        )
        sum_dict["Androidx usage number"] += new_cat_data["Androidx usage number"]
        sum_dict["Androidx usage rate"] = (
            sum_dict["Androidx usage number"] / sum_dict["App number"]
        )
    if sum_dict["Platform usage number"] != 0:
        sum_dict["Mono usage number"] += new_cat_data["Mono usage number"]
        sum_dict["Mono usage rate in all platform"] = (
            sum_dict["Mono usage number"] / sum_dict["Platform usage number"]
        )
        sum_dict["React usage number"] += new_cat_data["React usage number"]
        sum_dict["React usage rate in all platform"] = (
            sum_dict["React usage number"] / sum_dict["Platform usage number"]
        )
        sum_dict["Flutter usage number"] += new_cat_data["Flutter usage number"]
        sum_dict["Flutter usage rate in all platform"] = (
            sum_dict["Flutter usage number"] / sum_dict["Platform usage number"]
        )
        sum_dict["Cordova usage number"] += new_cat_data["Cordova usage number"]
        sum_dict["Cordova usage rate in all platform"] = (
            sum_dict["Cordova usage number"] / sum_dict["Platform usage number"]
        )
        sum_dict["Capacitor usage number"] += new_cat_data["Capacitor usage number"]
        sum_dict["Capacitor usage rate in all platform"] = (
            sum_dict["Capacitor usage number"] / sum_dict["Platform usage number"]
        )
    return sum_dict
...
for dirname in dirnames:
    ...
    for row in csvreader:
        ...
        if row["Androidx used"] == "True":
            apk_catigory_res["Androidx usage number"] += 1
            apk_catigory_res["Androidx usage rate"] = (
                apk_catigory_res["Androidx usage number"]
                / apk_catigory_res["App number"]
            )
            ...
            writer.writerow(
                {
                    ...
                    "Cordova usage rate in all platform": apk_static_res[cat_dict_name][
                        "Cordova usage rate in all platform"
                    ],
                    ...
                    "Androidx usage number":apk_static_res[
                        cat_dict_name
                    ]["Androidx usage number"],
                    "Androidx usage rate":apk_static_res[
                        cat_dict_name
                    ]["Androidx usage rate"],
                }
            )
